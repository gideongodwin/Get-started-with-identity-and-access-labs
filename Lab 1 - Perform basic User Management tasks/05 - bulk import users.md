...
<img width="1414" height="332" alt="14" src="https://github.com/user-attachments/assets/d6ca2a46-31fa-4420-b46b-3c95f5bd45d3" />
...
4. In the upload section, click the blue folder icon next to the CSV field.
5. When the file picker opens, browse to your CSV file.
...
8. Wait for the notification that the file uploaded successfully.
9. Select the Submit button to add the users.
