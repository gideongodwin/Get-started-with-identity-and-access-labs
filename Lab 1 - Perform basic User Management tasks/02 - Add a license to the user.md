...
3. When the list of licenses appears, select `Power Automate Premium`
...
5. Choose Brogeswar from the list (user created in previous task).
...
7. Notice the message that you have successfully assigned a license.

   <img width="1920" height="404" alt="517727445-27fd4956-a318-4b4e-bd5a-6fa5d07855d1" src="https://github.com/user-attachments/assets/dc77115c-6527-46f0-88ad-854734571847" />
